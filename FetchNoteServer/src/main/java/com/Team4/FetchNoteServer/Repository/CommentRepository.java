...
public class CommentRepository {
    ...
    public void CreateComment(CommentInput commentInput, Long id) {
    ...
    public String ChangeComment(Long id, CommentInput commentInput) {
        ...
        if(comment.getUsers().getId() == commentInput.getUserId() && !comment.getComment().equals(commentInput.getComment())) {
            isChange = true;
