...
--Fail
INSERT INTO `patch` (id, user_id, game_id, title, body, image, `right`, wrong, created_at, updated_at) VALUES (1, 1, 1, "11.01 패치내역", "저는 거짓말 안합니다", "0", 3, 2, now(), now());
INSERT INTO `patch` (id, user_id, game_id, title, body, image, `right`, wrong, created_at, updated_at) VALUES (2, 2, 1, "11.02 패치내역", "좋아요 많이 눌러주세요", "0", 10, 0, now(), now());
INSERT INTO `patch` (id, user_id, game_id, title, body, image, `right`, wrong, created_at, updated_at) VALUES (3, 3, 2, "신규 아이콘 카드 업데이트", "아이콘 박지성 너무좋아요", "0", 1, 11, now(), now());
INSERT INTO `patch` (id, user_id, game_id, title, body, image, `right`, wrong, created_at, updated_at) VALUES (4, 4, 3, "신규 알고리즘 업데이트", "저는 거짓말 안합니다", "0", 20, 2, now(), now());
